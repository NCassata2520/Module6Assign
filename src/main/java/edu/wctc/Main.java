...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            DiceGame diceGame = new DiceGame(players, 5, 3, players, dice, maxRolls);
    ...
    public static void playGame(DiceGame game, Scanner keyboard) {
        ...
        do {
            ...
            System.out.printf("PLAYER %d's TURN%n", game.getCurrentPlayerNumber(currentPlayer));
            ...
            System.out.printf("PLAYER %d's SCORE: %d %n%n",
                    game.getCurrentPlayerNumber(currentPlayer), game.getCurrentPlayerScore());
